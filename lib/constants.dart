...
const String kInvalidEmailError = "Email yang anda masukkan salah";
const String kPassNullError = "Harap masukkan sandi anda";
const String kShortPassError = "Sandi terlalu pendek";
